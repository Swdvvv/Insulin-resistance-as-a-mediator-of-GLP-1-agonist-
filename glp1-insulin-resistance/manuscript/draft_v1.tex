...
% ----------------------------------------------------------------- TITLE ---
\title{\fontsize{16}{20}\selectfont
  Central Insulin Resistance as a Mediator of GLP-1 Receptor Agonist
  Neuroprotection in Alzheimer's and Parkinson's Disease: A Systematic
  Evidence Synthesis and Exploratory Transcriptomic Analysis
}
\author{%
  Seungwon Yang$^{1}$ \\
  \small $^{1}$Department of Life Sciences, Pharmacology, University of Nottingham
}
\date{\today}
